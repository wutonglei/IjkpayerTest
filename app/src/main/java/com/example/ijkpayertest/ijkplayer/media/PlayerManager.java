package com.example.ijkpayertest.ijkplayer.media;
...
import com.example.ijkpayertest.R;
...
public class PlayerManager {
    ...
    public OnVolumeChangeListener onVolumeChangeListener = null;
...
//            $.id(R.id.app_video_loading).visible();
    ...
    private void onVolumeSlide(float percent) {
        ...
        if (null != onVolumeChangeListener) {
            onVolumeChangeListener.onVolumeChange(index);
        }
        // 变更进度条
    ...
    public class PlayerGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            if (toSeek) {
                ...
                float percent = deltaY / (videoView.getHeight() * 2 / 5);
                if (volumeControl) {
    ...
    public PlayerManager onVolumeChange(OnVolumeChangeListener onVolumeChangeListener) {
